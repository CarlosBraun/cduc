class IncidentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @incident.update(incident_params)
        format.html { redirect_to ticket_url(Ticket.last), notice: "Incident was successfully updated." }
  ...
  private
    ...
    def incident_params
      params.fetch(:incident, {}).permit(:id, :summary, :description, :creation_date, :comment_id)
    end
end
